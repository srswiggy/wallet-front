...
function UserRegistration () {
  ...
  const handleRegistrationSubmit = (username, pass) => {
  ...
  return (
    <div className='h-screen flex justify-center items-center'>
      <div className='w-[30vw] bg-white p-12 rounded-lg'>
        <h1 className='text-3xl text-center pb-8 font-medium'>Create New User</h1>
      <form>
      <div className="mb-6">
    ...
    <Button className='px-8' size="lg" onClick={() => handleRegistrationSubmit(inputUsername, inputPassword)}>Submit</Button>
